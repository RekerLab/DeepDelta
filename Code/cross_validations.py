...
def cross_validation(x, y, prop, model, k=10, seed=1): 
...
def cross_validation_file(data_path, prop, model, k=10, seed=1):
...
for model in models:
    for prop in properties:
        ...
        delta.to_csv("{}_{}_delta_scoring.csv".format(prop, model))